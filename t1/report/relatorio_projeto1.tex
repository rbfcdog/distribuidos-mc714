...
\midrule
Round Robin & 0,600 & 0,06500 & 0,0\% \\
RR Ponderado & 0,600 & 0,04904 & 24,6\% \\
Trabalho Mínimo & 0,600 & 0,04911 & 24,4\% \\
Poder de Duas & 0,600 & 0,04912 & 24,4\% \\
\bottomrule
\end{tabular}
\end{table}

A Tabela~\ref{tab:extras} mostra que todas concluem 120 requisições, logo a vazão continua $0{,}60$. A diferença está no atraso: Round Robin sobrecarrega o servidor mais lento, enquanto as três políticas cientes de capacidade obtêm resposta próxima. Round Robin Ponderado apresenta a menor média, mas a vantagem de $0{,}00007$ sobre Trabalho Mínimo é pequena diante da escala observada; Poder de Duas aproxima os dois resultados consultando somente um par.

\subsection{Buffers finitos e backup}
No segundo extra, cada primário tem buffer para duas requisições. Sem backup, a execução rejeita em média 8,6 requisições e produz $\Theta=0{,}5570$. Um quarto servidor $(c,S)=(15,0{,}05)$ fica fora do conjunto de roteamento normal. Quando o primário selecionado não possui posição nem buffer, a requisição é desviada ao backup. Em média, ocorrem 8,6 acionamentos, nenhuma rejeição, $\Theta=0{,}60$ e resposta $0{,}05141$.
