...
\clearpage
\section{Extensões e políticas adicionais}
...
A validação possui quatro níveis. Primeiro, testes determinísticos exercitam precedência de partidas, capacidade simultânea, formação de fila, término no horizonte, integral de ocupação, rejeição e ativação do backup. Segundo, testes de política verificam ciclos independentes, desempates, exclusão do backup, proporção ponderada $1{:}2{:}3$ e escolha do menos carregado entre dois destinos. Terceiro, sementes separadas garantem tráfego idêntico entre políticas. Por fim, os CSVs são regenerados diretamente pelo executável e os gráficos apenas transformam esses dados.
